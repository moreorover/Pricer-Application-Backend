...
public class NoScrapeProfile {
    ...
    public NoScrapeProfile(StoreRepository storeRepository, ItemRepository itemRepository, DealRepository dealRepository, ParserErrorRepository parserErrorRepository) {
...
//        new Scraper(subject, SimpkinsJewellersParser(), getMongoItemService(), 1);
    ...
    public Launcher runner() {
        return new Launcher(getMongoStoreService(), getSubject(), jda(), dealRepository);
    }
}

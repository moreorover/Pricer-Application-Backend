...
@Slf4j
public class ErnestJonesParser implements ParserI {

    public final String NAME = "Ernest Jones";
    public final String PREFIX = "EJ_";
    public final String BASE_URL = "https://www.ernestjones.co.uk";
